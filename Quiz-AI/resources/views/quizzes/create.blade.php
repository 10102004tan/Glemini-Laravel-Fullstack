        ...
        <div>
            ...
            <div class="flex items-center justify-between">
                ...
                <i class="fa-sharp fa-regular fa-share-nodes p-2"></i>
                    ...
                    @if ($quiz->status == 0)
                    <button type="button" class="py-2 px-2 rounded bg-green-500" data-modal-target="default-modal" data-modal-toggle="default-modal">
                        Publish
                    </button>
...
<!-- Main modal -->
@isset($quiz)
<div id="default-modal" tabindex="-1" aria-hidden="true" class="hidden z-[99999] overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0  justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
        ...
        <div class="relative bg-primary rounded-lg shadow">
            ...
            <div class="p-4 md:p-5 space-y-4 modal-body">
                <div class="published-body">
                    <h3>Hello world</h3>
                    <!-- Modal footer -->
                    <div class="flex items-center pt-4 md:p-5 border-t border-gray-200 rounded-b dark:border-gray-600">
                        <button quizId="{{$quiz->id}}" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 btn-published focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Published</button>
                        <button data-modal-hide="default-modal" type="button" class="py-2.5 px-5 ms-3 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">Draft</button>
                    </div>
                </div>
            </div>
        </div>
