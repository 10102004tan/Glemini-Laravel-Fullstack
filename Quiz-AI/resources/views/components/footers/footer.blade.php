    ...
    <div class="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-28">
        <div class="xl:grid xl:grid-cols-3 xl:gap-10">
            <div class="mt-10 xl:mt-0">
                <img class="w-4 rounded-md" src="{{ asset('images/icon-white.png') }}" alt="">
                <div class="mt-4 border-gray-900/10 pt-4 md:flex md:items-center md:justify-between">
                    <div class="flex space-x-6 md:order-2">
                        ...
                        <a target="_blank" href="#" class="text-gray-400 cursor-pointer hover:text-gray-700 mr-2 rtl:ml-2">
                            <span class="sr-only">Email</span>
                            <svg class="inline-block w-6 h-7 text-gray-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
